...
/**
 * POST /device-status/reachability/subscriptions
 * Create a reachability status subscription - Returns 201 Created
 */
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const result = await adapter.createReachabilitySubscription({
    ...
    console.error('Create reachability subscription error:', error);
